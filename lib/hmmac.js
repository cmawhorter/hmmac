...
Hmmac.prototype.headerPrefix = function (prefix) {
 ...
 * @return {*}
 */
Hmmac.prototype.hash = function (hash) {
 ...
 * @param serviceLabel
 */
Hmmac.prototype.serviceLabel = function (serviceLabel) {
 ...
 * @return {*}
 */
Hmmac.prototype.debug = function (debug) {
 ...
 * @private
 */
Hmmac.prototype._locateHeadersByPrefix = function (request) {
 ...
 * @private
 */
Hmmac.prototype._locateHeader = function (request, headerName) {
 ...
 * @private
 */
Hmmac.prototype._buildCanonicalStringFromRequest = function (request) {
 ...
 * @private
 */
Hmmac.prototype._validateRequiredOptions = function (credentials) {
 ...
 * @private
 */
Hmmac.prototype._generateHMACSignature = function (credentials, canonicalString) {
 ...
 * @return {*}
 */
Hmmac.prototype.signHttpRequest = function (credentials, request, canonicalStringCallback) {
...
Hmmac.prototype._verifyValidateHttpRequestSync = function (request) {
 ...
 * @api public
 */
Hmmac.prototype.validateHttpRequestSync = function (request, authCallback) {
 ...
 * @api public
 */
Hmmac.prototype.validateHttpRequest = function (request, authCallback, callback) {
    if (arguments.length == 2) {
        if (this.options.debug) console.warn('Warning: Calling validateHttpRequest syncronously is deprecated.  Please use Hmmac::validateHttpRequestSync.');
...
/**
 * Gets the express/connection hmmac middleware lazily
 *
 * @return {*}
 * @api public
 */

Hmmac.middleware = function () { // defer
    return require('./middleware').apply(this, arguments);
};

exports = module.exports = Hmmac;
